...
const SingleProduct = () => {
  ...
  return (
    <>
      ...
      <Container class1="main-product-wrapper py-5 home-wrapper-2 py-1">
        <div className="row">
          <div className="col-6">
          ...
          <div className="col-12">
            ...
            <div className="bg-white p-3">
              <p>
                ...
                you want to become. You never know who these people may be
                (possibly your roommate, neighbor, coworker, longlost friend,
                lover, or even a complete stranger) but when you lock eyes with
                them, you know at that very moment that they will affect your
              ...
              <div className="reviews mt-2">
                <div className="review">
                  ...
                  <p>
                    ...
                    purpose, teach you a lesson, or to help you figure out who
                    you are or who you want to become. You never know who these
                    people may be (possibly your roommate, neighbor, coworker,
                    longlost friend, lover, or even a complete stranger) but
                    when you lock eyes with them, you know at that very moment
