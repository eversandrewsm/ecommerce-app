          ...
          <div className="row">
            <div className="col-4">
              ...
              <div>
                ...
                <a
                  href="mailto: info@integratech.co.za"
                  className="mt-3 d-block mb-0 text-white"
                >
                  info@integratech.co.za
                </a>
                <div className="social_icons d-flex align-items-center gap-20 mt-3">
          ...
          <div className="row">
            <div className="col-12">
              <p className="text-center mb-0 text-white">
                &copy; {new Date().getFullYear()}; Poweredby Integratech
                Technologies.
              </p>
            </div>
          </div>
